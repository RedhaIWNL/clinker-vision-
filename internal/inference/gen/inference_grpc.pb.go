...
const (
	InferenceService_Infer_FullMethodName = "/clinkervision.inference.v1.InferenceService/Infer"
)
...
var InferenceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "clinkervision.inference.v1.InferenceService",
