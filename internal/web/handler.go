...
func NewHandler(healthHandler *health.Handler, metricHandler *metrics.Metrics, apiHandlers ...*API) http.Handler {
...
func NewHandlerWithAPI(healthHandler *health.Handler, metricHandler *metrics.Metrics, api *API) http.Handler {
	return NewHandler(healthHandler, metricHandler, api)
}
